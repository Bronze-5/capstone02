						...
						<div class="row">
							...
							<div class="span6">
								<div class="carousel-caption">
									...
									<p class="lead">We give you the best knowledge.</p>
  ...
  ==============================================-->
		...
		<div class="row feature-box">
			<div class="span12 cnt-title">
				<h1>Provide friendly study and exam interfaces.</h1>
				<span>--- Practice test, Do exercises, Practice test ---</span>
			</div>
		...
		<div class="row">
			...
			<div class="span4">
				...
				<p align="justify">Every year, thousands of students attend
							Attend English courses at IES and get the results you want. 
							We are proud to be one of the favorite language centers,
							is a reliable address for students of DUY TAN, Economics, Construction,
							Banks... and many people go to work in Da Nang</p>
